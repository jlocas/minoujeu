...
class MainFrame(wx.Frame):
    ...
    def __init__(self, parent, title, pos, size, audio):
        ...
        self.tractParams = [["Base", 20, 10, 1000, 2, self.handleTractBase], ["Length", 0.2, 20, 5000, 3, self.handleTractLength], ["Resonance", 10, 5, 60, 1, self.handleTractResonance]] #parametre, val, min, max, precision, handler
...
mainFrame = MainFrame(None, title="Vocalizer", pos=(350,0), size=(1000,600), audio=audio)
